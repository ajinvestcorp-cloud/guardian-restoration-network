...
SERVICES = {
    ...
    "biohazard-cleanup": {
        ...
        "city_slug_prefix": "biohazard-cleanup",
        "icon": "⚠️",
    ...
    "asbestos-abatement": {
        ...
        "city_slug_prefix": "asbestos-abatement",
        "icon": "🏗️",
...
CITIES = {
    ...
    # ── OREGON ──────────────────────────────────────────────────────────────
    "portland-or": {
        "city": "Portland", "state": "Oregon", "abbrev": "OR",
        "context": {
    ...
    "salem-or": {
        "city": "Salem", "state": "Oregon", "abbrev": "OR",
        "context": {
    ...
    "eugene-or": {
        "city": "Eugene", "state": "Oregon", "abbrev": "OR",
        "context": {
    ...
    "bend-or": {
        "city": "Bend", "state": "Oregon", "abbrev": "OR",
        "context": {
    ...
    "medford-or": {
        "city": "Medford", "state": "Oregon", "abbrev": "OR",
        "context": {
    ...
    "corvallis-or": {
        "city": "Corvallis", "state": "Oregon", "abbrev": "OR",
        "context": {
    ...
    # ── WASHINGTON ───────────────────────────────────────────────────────────
    "seattle-wa": {
        "city": "Seattle", "state": "Washington", "abbrev": "WA",
        "context": {
    ...
    "spokane-wa": {
        "city": "Spokane", "state": "Washington", "abbrev": "WA",
        "context": {
    ...
    "tacoma-wa": {
        "city": "Tacoma", "state": "Washington", "abbrev": "WA",
        "context": {
    ...
    "vancouver-wa": {
        "city": "Vancouver", "state": "Washington", "abbrev": "WA",
        "context": {
    ...
    "bellevue-wa": {
        "city": "Bellevue", "state": "Washington", "abbrev": "WA",
        "context": {
    ...
    "kent-wa": {
        "city": "Kent", "state": "Washington", "abbrev": "WA",
        "context": {
    ...
    "everett-wa": {
        "city": "Everett", "state": "Washington", "abbrev": "WA",
        "context": {
    ...
    "spokane-valley-wa": {
        "city": "Spokane Valley", "state": "Washington", "abbrev": "WA",
        "context": {
    ...
    "renton-wa": {
        "city": "Renton", "state": "Washington", "abbrev": "WA",
        "context": {
    ...
    "federal-way-wa": {
        "city": "Federal Way", "state": "Washington", "abbrev": "WA",
        "context": {
    ...
    "yakima-wa": {
        "city": "Yakima", "state": "Washington", "abbrev": "WA",
        "context": {
    ...
    "bellingham-wa": {
        "city": "Bellingham", "state": "Washington", "abbrev": "WA",
        "context": {
    ...
    "kirkland-wa": {
        "city": "Kirkland", "state": "Washington", "abbrev": "WA",
        "context": {
    ...
    "kennewick-wa": {
        "city": "Kennewick", "state": "Washington", "abbrev": "WA",
        "context": {
    ...
    "auburn-wa": {
        "city": "Auburn", "state": "Washington", "abbrev": "WA",
        "context": {
    ...
    "redmond-wa": {
        "city": "Redmond", "state": "Washington", "abbrev": "WA",
        "context": {
    ...
    "pasco-wa": {
        "city": "Pasco", "state": "Washington", "abbrev": "WA",
        "context": {
    ...
    "marysville-wa": {
        "city": "Marysville", "state": "Washington", "abbrev": "WA",
        "context": {
    ...
    "sammamish-wa": {
        "city": "Sammamish", "state": "Washington", "abbrev": "WA",
        "context": {
    ...
    "richland-wa": {
        "city": "Richland", "state": "Washington", "abbrev": "WA",
        "context": {
    ...
    "lakewood-wa": {
        "city": "Lakewood", "state": "Washington", "abbrev": "WA",
        "context": {
    ...
    "shoreline-wa": {
        "city": "Shoreline", "state": "Washington", "abbrev": "WA",
        "context": {
    ...
    "lacey-wa": {
        "city": "Lacey", "state": "Washington", "abbrev": "WA",
        "context": {
    ...
    "olympia-wa": {
        "city": "Olympia", "state": "Washington", "abbrev": "WA",
        "context": {
    ...
    "burien-wa": {
        "city": "Burien", "state": "Washington", "abbrev": "WA",
        "context": {
    ...
    "bothell-wa": {
        "city": "Bothell", "state": "Washington", "abbrev": "WA",
        "context": {
    ...
    # ── CALIFORNIA ───────────────────────────────────────────────────────────
    "los-angeles-ca": {
        "city": "Los Angeles", "state": "California", "abbrev": "CA",
        "context": {
    ...
    "san-diego-ca": {
        "city": "San Diego", "state": "California", "abbrev": "CA",
        "context": {
    ...
    "san-jose-ca": {
        "city": "San Jose", "state": "California", "abbrev": "CA",
        "context": {
    ...
    "san-francisco-ca": {
        "city": "San Francisco", "state": "California", "abbrev": "CA",
        "context": {
    ...
    "fresno-ca": {
        "city": "Fresno", "state": "California", "abbrev": "CA",
        "context": {
    ...
    "sacramento-ca": {
        "city": "Sacramento", "state": "California", "abbrev": "CA",
        "context": {
    ...
    "long-beach-ca": {
        "city": "Long Beach", "state": "California", "abbrev": "CA",
        "context": {
    ...
    "oakland-ca": {
        "city": "Oakland", "state": "California", "abbrev": "CA",
        "context": {
    ...
    "bakersfield-ca": {
        "city": "Bakersfield", "state": "California", "abbrev": "CA",
        "context": {
    ...
    "anaheim-ca": {
        "city": "Anaheim", "state": "California", "abbrev": "CA",
        "context": {
    ...
    "santa-ana-ca": {
        "city": "Santa Ana", "state": "California", "abbrev": "CA",
        "context": {
    ...
    "riverside-ca": {
        "city": "Riverside", "state": "California", "abbrev": "CA",
        "context": {
    ...
    "stockton-ca": {
        "city": "Stockton", "state": "California", "abbrev": "CA",
        "context": {
    ...
    "chula-vista-ca": {
        "city": "Chula Vista", "state": "California", "abbrev": "CA",
        "context": {
    ...
    "fremont-ca": {
        "city": "Fremont", "state": "California", "abbrev": "CA",
        "context": {
    ...
    "irvine-ca": {
        "city": "Irvine", "state": "California", "abbrev": "CA",
        "context": {
    ...
    "glendale-ca": {
        "city": "Glendale", "state": "California", "abbrev": "CA",
        "context": {
            "water-damage": "Glendale's hillside neighborhoods and older housing stock create water intrusion risk during atmospheric river events. The city's aging infrastructure and proximity to the Verdugo Mountains create flood and water damage exposure for residential properties throughout the San Fernando Valley edge.",
            "fire-damage": "Glendale borders the Verdugo Mountains and sits in a high wildfire risk zone. The 2020 Bobcat and other recent fires have threatened Glendale's hillside neighborhoods. Wind-driven fire conditions during Santa Ana events are a recurring threat to residential areas.",
            "mold-remediation": "Glendale's older housing stock and periodic water intrusion events create mold risk in crawl spaces and wall cavities. Post-water damage mold grows quickly in Southern California's mild climate if not immediately remediated.",
            "storm-damage": "Glendale experiences atmospheric river events and Santa Ana wind conditions that cause flooding, roof damage, and debris impacts in hillside and flatland neighborhoods throughout the city.",
            "biohazard-cleanup": "Glendale has consistent demand for biohazard, unattended death, and hoarding cleanup services across its large residential and commercial market as one of the San Fernando Valley's largest cities.",
            "asbestos-abatement": "Glendale has a substantial inventory of pre-1980 housing with asbestos in popcorn ceilings, floor tiles, pipe insulation, and drywall compound throughout its established residential neighborhoods.",
            "general-contractor": "Glendale's large residential market and wildfire exposure create strong demand for licensed general contractors handling insurance reconstruction after fire, water, and storm damage events.",
        }
    },
    "huntington-beach-ca": {
        "city": "Huntington Beach", "state": "California", "abbrev": "CA",
        "context": {
            "water-damage": "Huntington Beach's coastal location makes it subject to atmospheric river flooding, storm surge, and stormwater backup events. The city's large stock of older residential housing is vulnerable to water intrusion and pipe failures during wet season events.",
            "fire-damage": "Huntington Beach's inland areas face wildfire risk during Santa Ana wind events. Wind-driven fire conditions threaten residential neighborhoods in the eastern and hillside portions of the city.",
            "mold-remediation": "Huntington Beach's coastal humidity and older housing stock create persistent mold risk in crawl spaces and wall cavities. Post-water damage mold grows rapidly in the coastal climate if not immediately remediated.",
            "storm-damage": "Huntington Beach experiences atmospheric river events and Santa Ana wind conditions that cause coastal flooding, roof damage, and structural impacts throughout the city.",
            "biohazard-cleanup": "Huntington Beach has consistent demand for biohazard, unattended death, and hoarding cleanup services across its large coastal residential market in Orange County.",
            "asbestos-abatement": "Huntington Beach has a substantial inventory of pre-1980 housing with asbestos in popcorn ceilings, floor tiles, pipe insulation, and drywall compound throughout its established residential neighborhoods.",
            "general-contractor": "Huntington Beach's large residential market and coastal exposure create strong demand for licensed general contractors handling insurance reconstruction after water, fire, and storm damage events.",
        }
    },
    "santa-clarita-ca": {
        "city": "Santa Clarita", "state": "California", "abbrev": "CA",
        "context": {
            "water-damage": "Santa Clarita's Santa Clara River valley location creates flood risk during atmospheric river events. The city's rapidly growing residential base includes both older and newer housing vulnerable to water intrusion and pipe failures.",
            "fire-damage": "Santa Clarita sits in one of Southern California's highest wildfire risk zones. The 2019 Tick Fire and other recent fires have burned through Santa Clarita neighborhoods. Wind-driven fires during Santa Ana conditions are a recurring and severe threat.",
            "mold-remediation": "Santa Clarita's periodic flooding and warm inland climate create mold risk following water damage events. Post-water damage mold grows rapidly in the hot inland climate if remediation is delayed.",
            "storm-damage": "Santa Clarita experiences atmospheric river events and Santa Ana wind conditions that cause flooding, roof damage, and structural impacts throughout the Santa Clara River valley.",
            "biohazard-cleanup": "Santa Clarita has consistent demand for biohazard, unattended death, and hoarding cleanup services as one of the Los Angeles metropolitan area's largest suburban communities.",
            "asbestos-abatement": "Santa Clarita has older residential areas with pre-1980 housing containing asbestos in popcorn ceilings, floor tiles, and pipe insulation alongside newer construction in master-planned communities.",
            "general-contractor": "Santa Clarita's large and growing residential market and extreme wildfire exposure create strong demand for licensed general contractors handling insurance reconstruction after fire, water, and storm damage events.",
        }
    },
    "san-bernardino-ca": {
        "city": "San Bernardino", "state": "California", "abbrev": "CA",
        "context": {
            "water-damage": "San Bernardino's Inland Empire location experiences atmospheric river flooding events that cause significant water intrusion in older residential neighborhoods. The Santa Ana River creates flood risk for low-lying properties. Cold winter temperatures cause pipe bursts in the city's aging housing stock.",
            "fire-damage": "San Bernardino sits at the foot of the San Bernardino Mountains with significant wildfire risk during Santa Ana wind events. Wind-driven fires have threatened San Bernardino neighborhoods on multiple occasions. The city's older housing stock carries elevated fire risk.",
            "mold-remediation": "San Bernardino's periodic flooding and hot Inland Empire summers create mold risk in older homes. Post-water damage mold grows rapidly in extreme heat if remediation is not immediate.",
            "storm-damage": "San Bernardino experiences atmospheric river events and Santa Ana wind conditions that cause flooding, roof damage, and mudslides in foothill neighborhoods throughout the Inland Empire.",
            "biohazard-cleanup": "San Bernardino has significant demand for biohazard, unattended death, crime scene, and hoarding cleanup services as the Inland Empire's county seat and a major urban center.",
            "asbestos-abatement": "San Bernardino has an extensive inventory of pre-1980 housing with asbestos in popcorn ceilings, floor tiles, pipe insulation, and drywall compound throughout its established residential neighborhoods.",
            "general-contractor": "San Bernardino's large residential market and exposure to fire, flood, and storm damage events create strong demand for licensed general contractors handling insurance reconstruction throughout the Inland Empire.",
        }
    },
    "modesto-ca": {
        "city": "Modesto", "state": "California", "abbrev": "CA",
        "context": {
            "water-damage": "Modesto's San Joaquin Valley location brings atmospheric river flooding events that cause water intrusion in residential neighborhoods. The Tuolumne River and its tributaries create flood risk. The city's large stock of older housing is vulnerable to pipe failures during cold winter freezes.",
            "fire-damage": "Modesto sits near the Sierra Nevada foothills with wildfire exposure during California's dry season. Surrounding agricultural and foothill communities create fire risk that can affect Modesto's eastern residential neighborhoods.",
            "mold-remediation": "Modesto's periodic flooding and hot Central Valley summers create mold risk in older homes. Post-water damage mold grows rapidly in extreme heat if remediation is delayed.",
            "storm-damage": "Modesto experiences atmospheric river flooding and wind events that cause significant damage in low-lying residential neighborhoods. Valley floor flooding during major rain events creates water damage risk.",
            "biohazard-cleanup": "Modesto has consistent demand for biohazard, unattended death, and hoarding cleanup services as the Central Valley's fourth largest city and Stanislaus County's seat.",
            "asbestos-abatement": "Modesto has a large inventory of pre-1980 housing with asbestos in popcorn ceilings, floor tiles, pipe insulation, and drywall compound throughout its established residential neighborhoods.",
            "general-contractor": "Modesto's large residential market and exposure to fire, flood, and storm damage events create strong demand for licensed general contractors handling insurance reconstruction throughout the Central Valley.",
        }
    },
    "moreno-valley-ca": {
        "city": "Moreno Valley", "state": "California", "abbrev": "CA",
        "context": {
            "water-damage": "Moreno Valley's Inland Empire location experiences atmospheric river flooding events. The city's rapidly growing residential base includes both older and newer housing vulnerable to water intrusion and pipe failures during wet season events.",
            "fire-damage": "Moreno Valley sits near the San Jacinto Mountains and Badlands with significant wildfire risk during hot dry summers and Santa Ana wind events. Wind-driven fires threaten Moreno Valley's residential neighborhoods.",
            "mold-remediation": "Moreno Valley's periodic flooding and hot Inland Empire summers create mold risk in older homes. Post-water damage mold grows rapidly in extreme heat if remediation is not immediate.",
            "storm-damage": "Moreno Valley experiences atmospheric river events and Santa Ana wind conditions that cause flooding, roof damage, and structural impacts throughout the Inland Empire metro area.",
            "biohazard-cleanup": "Moreno Valley has consistent demand for biohazard, unattended death, and hoarding cleanup services as one of the Inland Empire's fastest-growing cities.",
            "asbestos-abatement": "Moreno Valley has older residential areas with pre-1980 housing containing asbestos in popcorn ceilings, floor tiles, and pipe insulation alongside newer construction.",
            "general-contractor": "Moreno Valley's large and growing residential market and exposure to fire, flood, and storm damage events create strong demand for licensed general contractors handling insurance reconstruction.",
        }
    },
    "fontana-ca": {
        "city": "Fontana", "state": "California", "abbrev": "CA",
        "context": {
            "water-damage": "Fontana's Inland Empire location experiences atmospheric river flooding events that cause water intrusion in residential neighborhoods. Cold winter temperatures cause pipe bursts in the city's older housing stock.",
            "fire-damage": "Fontana sits in the Inland Empire at the edge of Southern California's high wildfire risk zone. Wind-driven fires during Santa Ana conditions have threatened Fontana neighborhoods. The surrounding foothills create ongoing fire exposure.",
            "mold-remediation": "Fontana's periodic flooding and hot Inland Empire summers create mold risk in older homes. Post-water damage mold grows rapidly in extreme heat if remediation is not immediate.",
            "storm-damage": "Fontana experiences atmospheric river events and Santa Ana wind conditions that cause flooding, roof damage, and structural impacts throughout the Inland Empire.",
            "biohazard-cleanup": "Fontana has consistent demand for biohazard, unattended death, and hoarding cleanup services as one of the Inland Empire's largest cities.",
            "asbestos-abatement": "Fontana has a substantial inventory of pre-1980 housing with asbestos in popcorn ceilings, floor tiles, pipe insulation, and drywall compound throughout its older residential neighborhoods.",
            "general-contractor": "Fontana's large residential market and exposure to fire, flood, and storm damage events create strong demand for licensed general contractors handling insurance reconstruction throughout the Inland Empire.",
        }
    },
    "oxnard-ca": {
        "city": "Oxnard", "state": "California", "abbrev": "CA",
        "context": {
            "water-damage": "Oxnard's coastal Ventura County location makes it subject to atmospheric river flooding and stormwater backup events. The city's agricultural and residential areas face significant water intrusion risk during wet season events.",
            "fire-damage": "Oxnard's inland areas and surrounding Ventura County face extreme wildfire risk during Santa Ana wind events. The 2018 Woolsey and Thomas fires devastated surrounding communities, demonstrating the severe fire risk in the region.",
            "mold-remediation": "Oxnard's coastal humidity and older housing stock create persistent mold risk. Post-water damage mold grows quickly in the coastal climate if not immediately remediated.",
            "storm-damage": "Oxnard experiences atmospheric river events and Santa Ana wind conditions that cause coastal flooding, roof damage, and structural impacts throughout Ventura County.",
            "biohazard-cleanup": "Oxnard has consistent demand for biohazard, unattended death, and hoarding cleanup services as Ventura County's largest city.",
            "asbestos-abatement": "Oxnard has a substantial inventory of pre-1980 housing with asbestos in popcorn ceilings, floor tiles, pipe insulation, and drywall compound throughout its established residential neighborhoods.",
            "general-contractor": "Oxnard's large residential market and coastal exposure create strong demand for licensed general contractors handling insurance reconstruction after water, fire, and storm damage events.",
        }
    },
    "garden-grove-ca": {
        "city": "Garden Grove", "state": "California", "abbrev": "CA",
        "context": {
            "water-damage": "Garden Grove's Orange County location experiences atmospheric river flooding events that cause water intrusion and sewer backups in older residential neighborhoods. The city's aging housing stock is vulnerable to pipe failures during wet season events.",
            "fire-damage": "Garden Grove's position in Orange County creates exposure to Santa Ana wind-driven fire conditions. Wind-driven fires have threatened nearby communities and the city's residential neighborhoods.",
            "mold-remediation": "Garden Grove's older, densely packed housing stock and periodic water intrusion events create significant mold risk. Post-water damage mold grows rapidly in Southern California's mild climate.",
            "storm-damage": "Garden Grove experiences atmospheric river events and Santa Ana wind conditions that cause flooding, roof damage, and structural impacts in residential neighborhoods throughout the city.",
            "biohazard-cleanup": "Garden Grove has significant demand for biohazard, unattended death, and hoarding cleanup services across its densely populated urban residential market in Orange County.",
            "asbestos-abatement": "Garden Grove has an extensive inventory of pre-1980 housing with asbestos in popcorn ceilings, floor tiles, pipe insulation, and drywall compound throughout its established residential neighborhoods.",
            "general-contractor": "Garden Grove's large residential market and exposure to water, fire, and storm damage events create strong demand for licensed general contractors handling insurance reconstruction throughout Orange County.",
        }
    },
    "oceanside-ca": {
        "city": "Oceanside", "state": "California", "abbrev": "CA",
        "context": {
            "water-damage": "Oceanside's coastal San Diego County location makes it subject to atmospheric river flooding and stormwater backup events. The city's mix of older housing and military-adjacent properties faces water intrusion risk during wet season events.",
            "fire-damage": "Oceanside's eastern inland areas face wildfire risk during Santa Ana wind events. The city's wildland-urban interface creates fire exposure for residential developments on the eastern edge.",
            "mold-remediation": "Oceanside's coastal humidity and older housing stock create persistent mold risk. Post-water damage mold grows quickly in the coastal climate if not immediately remediated.",
            "storm-damage": "Oceanside experiences atmospheric river events and Santa Ana wind conditions that cause coastal flooding, roof damage, and structural impacts in residential neighborhoods.",
            "biohazard-cleanup": "Oceanside has consistent demand for biohazard, unattended death, and hoarding cleanup services as one of San Diego County's largest cities with a large military community near Camp Pendleton.",
            "asbestos-abatement": "Oceanside has older residential neighborhoods with pre-1980 housing containing asbestos in popcorn ceilings, floor tiles, and pipe insulation alongside newer construction.",
            "general-contractor": "Oceanside's growing residential market creates strong demand for licensed general contractors handling insurance reconstruction after water, fire, and storm damage events in coastal San Diego County.",
        }
    },
    "lancaster-ca": {
        "city": "Lancaster", "state": "California", "abbrev": "CA",
        "context": {
            "water-damage": "Lancaster's Antelope Valley high desert location brings cold winters with hard freezes that cause pipe bursts. Periodic atmospheric river events cause flooding in low-lying areas. The city's large stock of older and newer housing faces water damage risk.",
            "fire-damage": "Lancaster sits in the Antelope Valley with significant wildfire risk during California's dry and windy season. Surrounding desert scrub and grasslands create fire exposure for residential properties on the city's edges.",
            "mold-remediation": "While Lancaster is dry, pipe burst events and periodic flooding create localized moisture conditions that lead to mold growth if not addressed immediately. Older homes in Lancaster are common mold sites.",
            "storm-damage": "Lancaster experiences wind events, dust storms, and occasional heavy rain that cause roof and structural damage. The Antelope Valley's open geography amplifies wind impacts throughout the area.",
            "biohazard-cleanup": "Lancaster has consistent demand for biohazard, unattended death, and hoarding cleanup services as the Antelope Valley's largest city and regional hub.",
            "asbestos-abatement": "Lancaster has older residential areas with pre-1980 housing containing asbestos in popcorn ceilings, floor tiles, and pipe insulation alongside newer construction.",
            "general-contractor": "Lancaster's large residential market and exposure to fire, flood, and wind damage events create strong demand for licensed general contractors handling insurance reconstruction.",
        }
    },
    "palmdale-ca": {
        "city": "Palmdale", "state": "California", "abbrev": "CA",
        "context": {
            "water-damage": "Palmdale's Antelope Valley high desert location brings cold winters with hard freezes that cause pipe bursts. Periodic atmospheric river events cause flooding in low-lying areas. The city's growing residential base faces water damage risk.",
            "fire-damage": "Palmdale sits in the Antelope Valley with significant wildfire risk during California's dry and windy season. Surrounding desert scrub creates fire exposure for residential properties throughout the region.",
            "mold-remediation": "While Palmdale is dry, pipe burst events and periodic flooding create localized moisture conditions that lead to mold growth if not addressed quickly. Newer construction with improper moisture barriers is also a risk factor.",
            "storm-damage": "Palmdale experiences wind events, dust storms, and occasional heavy rain that cause roof and structural damage. The Antelope Valley's open geography amplifies wind impacts throughout the area.",
            "biohazard-cleanup": "Palmdale has consistent demand for biohazard, unattended death, and hoarding cleanup services as one of the Antelope Valley's primary cities.",
            "asbestos-abatement": "Palmdale has older residential areas with pre-1980 housing containing asbestos in popcorn ceilings, floor tiles, and pipe insulation alongside newer construction.",
            "general-contractor": "Palmdale's large and growing residential market creates strong demand for licensed general contractors handling insurance reconstruction after fire, water, and storm damage events.",
        }
    },
    "salinas-ca": {
        "city": "Salinas", "state": "California", "abbrev": "CA",
        "context": {
            "water-damage": "Salinas's Salinas Valley location brings atmospheric river flooding events that cause significant water intrusion in residential neighborhoods. The Salinas River creates flood risk for low-lying properties. The city's older housing stock is vulnerable to water damage.",
            "fire-damage": "Salinas sits near the Santa Lucia Range with wildfire exposure during California's dry season. Surrounding agricultural and foothill communities create fire risk that affects the region.",
            "mold-remediation": "Salinas's coastal proximity and periodic flooding events create mold risk in older homes. The city's agricultural community creates unique moisture conditions that drive mold growth in residential properties.",
            "storm-damage": "Salinas experiences atmospheric river flooding and wind events that cause significant damage in low-lying residential neighborhoods. Valley floor flooding during major rain events creates water damage risk.",
            "biohazard-cleanup": "Salinas has consistent demand for biohazard, unattended death, and hoarding cleanup services as Monterey County's largest city.",
            "asbestos-abatement": "Salinas has a large inventory of pre-1980 housing with asbestos in popcorn ceilings, floor tiles, pipe insulation, and drywall compound throughout its established residential neighborhoods.",
            "general-contractor": "Salinas's residential market and exposure to flood and storm damage events create demand for licensed general contractors handling insurance reconstruction throughout the Salinas Valley.",
        }
    },
    "corona-ca": {
        "city": "Corona", "state": "California", "abbrev": "CA",
        "context": {
            "water-damage": "Corona's Inland Empire location experiences atmospheric river flooding events. The Santa Ana River and its tributaries create flood risk for low-lying properties. Cold winter temperatures cause pipe bursts in older housing.",
            "fire-damage": "Corona sits in the Inland Empire adjacent to the Cleveland National Forest with significant wildfire risk during Santa Ana wind events. Wind-driven fires have threatened Corona neighborhoods and the wildland-urban interface creates ongoing fire exposure.",
            "mold-remediation": "Corona's periodic flooding and hot Inland Empire summers create mold risk in older homes. Post-water damage mold grows rapidly in extreme heat if remediation is not immediate.",
            "storm-damage": "Corona experiences atmospheric river events and Santa Ana wind conditions that cause flooding, roof damage, and structural impacts throughout the Inland Empire.",
            "biohazard-cleanup": "Corona has consistent demand for biohazard, unattended death, and hoarding cleanup services across its large residential market in western Riverside County.",
            "asbestos-abatement": "Corona has older residential neighborhoods with pre-1980 housing containing asbestos in popcorn ceilings, floor tiles, pipe insulation, and drywall compound.",
            "general-contractor": "Corona's large residential market and exposure to fire, flood, and storm damage events create strong demand for licensed general contractors handling insurance reconstruction throughout the Inland Empire.",
        }
    },
    "hayward-ca": {
        "city": "Hayward", "state": "California", "abbrev": "CA",
        "context": {
            "water-damage": "Hayward's East Bay location experiences atmospheric river flooding events that cause water intrusion in residential neighborhoods. The city's proximity to San Francisco Bay creates flood risk in low-lying areas, and older housing in established neighborhoods is vulnerable to water damage.",
            "fire-damage": "Hayward's hillside neighborhoods sit in the wildland-urban interface with significant wildfire risk during dry season wind events. The East Bay hills create ongoing fire exposure for upper Hayward residential areas.",
            "mold-remediation": "Hayward's coastal Bay Area climate and older housing stock create persistent mold risk in crawl spaces and wall cavities. Post-water damage mold is a common issue in the city's established residential neighborhoods.",
            "storm-damage": "Hayward experiences atmospheric river events and wind storms that cause flooding, roof damage, and structural impacts throughout the city. Bay-adjacent low-lying areas face elevated flood risk.",
            "biohazard-cleanup": "Hayward has consistent demand for biohazard, unattended death, and hoarding cleanup services across its large and diverse residential market in the East Bay.",
            "asbestos-abatement": "Hayward has a substantial inventory of pre-1980 housing with asbestos in popcorn ceilings, floor tiles, pipe insulation, and drywall compound throughout its established residential neighborhoods.",
            "general-contractor": "Hayward's large residential market and exposure to fire, flood, and storm damage events create strong demand for licensed general contractors managing insurance reconstruction throughout the East Bay.",
        }
    },
    "pomona-ca": {
        "city": "Pomona", "state": "California", "abbrev": "CA",
        "context": {
            "water-damage": "Pomona's Inland Empire location experiences atmospheric river flooding events that cause water intrusion in older residential neighborhoods. The city's large stock of older housing is particularly vulnerable to water damage during wet season events.",
            "fire-damage": "Pomona sits at the foot of the San Gabriel Mountains with significant wildfire risk during Santa Ana wind events. Wind-driven fires have threatened Pomona neighborhoods and the mountain interface creates ongoing fire exposure.",
            "mold-remediation": "Pomona's older, densely packed housing stock and periodic water intrusion events create significant mold risk. Post-water damage mold grows rapidly in Southern California's mild climate.",
            "storm-damage": "Pomona experiences atmospheric river events and Santa Ana wind conditions that cause flooding, roof damage, and structural impacts in residential neighborhoods throughout the city.",
            "biohazard-cleanup": "Pomona has significant demand for biohazard, unattended death, and hoarding cleanup services across its densely populated urban residential market.",
            "asbestos-abatement": "Pomona has an extensive inventory of pre-1980 housing with asbestos in popcorn ceilings, floor tiles, pipe insulation, and drywall compound. The city's older housing stock frequently requires asbestos testing and abatement before restoration work.",
            "general-contractor": "Pomona's large residential market and exposure to water, fire, and storm damage events create strong demand for licensed general contractors handling insurance reconstruction.",
        }
    },
    "escondido-ca": {
        "city": "Escondido", "state": "California", "abbrev": "CA",
        "context": {
            "water-damage": "Escondido's inland San Diego County location experiences atmospheric river flooding events. The city's older housing stock is vulnerable to water intrusion and pipe failures during wet season events.",
            "fire-damage": "Escondido sits in one of San Diego County's highest wildfire risk areas. Santa Ana wind-driven fires have threatened Escondido neighborhoods on multiple occasions. The city's rural-urban interface creates significant ongoing fire exposure.",
            "mold-remediation": "Escondido's periodic flooding and warm inland climate create mold risk following water damage events. Post-water damage mold grows quickly in the mild climate if not immediately remediated.",
            "storm-damage": "Escondido experiences atmospheric river events and Santa Ana wind conditions that cause flooding, roof damage, and mudslides in hillside neighborhoods.",
            "biohazard-cleanup": "Escondido has consistent demand for biohazard, unattended death, and hoarding cleanup services as one of San Diego County's largest inland cities.",
            "asbestos-abatement": "Escondido has older residential neighborhoods with pre-1980 housing containing asbestos in popcorn ceilings, floor tiles, and pipe insulation alongside newer construction.",
            "general-contractor": "Escondido's residential market and wildfire exposure create strong demand for licensed general contractors handling insurance reconstruction after fire, water, and storm damage events.",
        }
    },
    "torrance-ca": {
        "city": "Torrance", "state": "California", "abbrev": "CA",
        "context": {
            "water-damage": "Torrance's coastal South Bay location makes it subject to atmospheric river flooding and stormwater backup events. The city's large stock of mid-century housing is vulnerable to water intrusion and pipe failures during wet season events.",
            "fire-damage": "Torrance's older residential neighborhoods contain aging housing stock with elevated fire risk from outdated electrical systems. Wind-driven fire conditions during Santa Ana events create fire risk throughout the South Bay area.",
            "mold-remediation": "Torrance's coastal humidity and older housing stock create persistent mold risk in crawl spaces and wall cavities. Post-water damage mold grows quickly in the city's mild coastal climate.",
            "storm-damage": "Torrance experiences atmospheric river events and Santa Ana wind conditions that cause flooding, roof damage, and structural impacts in residential neighborhoods throughout the South Bay.",
            "biohazard-cleanup": "Torrance has consistent demand for biohazard, unattended death, and hoarding cleanup services across its large residential market in the South Bay.",
            "asbestos-abatement": "Torrance has an extensive inventory of pre-1980 housing with asbestos in popcorn ceilings, floor tiles, pipe insulation, and drywall compound throughout its established residential neighborhoods.",
            "general-contractor": "Torrance's large residential market and ongoing exposure to water, fire, and storm damage events create strong demand for licensed general contractors managing insurance reconstruction throughout the South Bay.",
        }
    },
    "sunnyvale-ca": {
        "city": "Sunnyvale", "state": "California", "abbrev": "CA",
        "context": {
            "water-damage": "Sunnyvale's Silicon Valley location experiences atmospheric river flooding events that cause water intrusion in residential neighborhoods. The city's older housing stock is vulnerable to pipe failures and water damage during wet season events.",
            "fire-damage": "Sunnyvale sits adjacent to the Santa Cruz Mountains and Diablo Range foothills with wildfire risk during dry season wind events. Tech campus and residential areas face fire exposure during Diablo wind conditions.",
            "mold-remediation": "Sunnyvale's older housing stock and periodic flooding events create significant mold risk. Silicon Valley's high-value real estate market demands professional mold remediation to protect property values.",
            "storm-damage": "Sunnyvale experiences atmospheric river events and wind-driven storms that cause flooding, roof damage, and structural impacts throughout the Santa Clara Valley.",
            "biohazard-cleanup": "Sunnyvale has consistent demand for biohazard, unattended death, and hoarding cleanup services across its large residential and tech-adjacent market in Silicon Valley.",
            "asbestos-abatement": "Sunnyvale has a significant inventory of pre-1980 housing with asbestos in popcorn ceilings, floor tiles, pipe insulation, and drywall compound. Silicon Valley's renovation activity frequently requires asbestos abatement.",
            "general-contractor": "Sunnyvale's high-value real estate market and ongoing exposure to fire, flood, and storm events create strong demand for licensed general contractors managing insurance reconstruction.",
        }
    },
    "pasadena-ca": {
        "city": "Pasadena", "state": "California", "abbrev": "CA",
        "context": {
            "water-damage": "Pasadena's location at the foot of the San Gabriel Mountains creates flooding risk from atmospheric river events and debris flows. The Arroyo Seco creates flood exposure for properties along its corridor. Older historic housing stock is particularly vulnerable.",
            "fire-damage": "Pasadena borders the Angeles National Forest with extreme wildfire risk during Santa Ana wind events. The 2009 Station Fire and other historic fires have threatened Pasadena's hillside neighborhoods. This is one of Los Angeles County's highest fire risk areas.",
            "mold-remediation": "Pasadena's older historic housing stock and periodic flooding events create mold risk. Post-water damage mold grows quickly in Southern California's mild climate if not immediately remediated.",
            "storm-damage": "Pasadena experiences atmospheric river events, Santa Ana wind conditions, and debris flows from the San Gabriel Mountains that cause flooding, roof damage, and structural impacts.",
            "biohazard-cleanup": "Pasadena has consistent demand for biohazard, unattended death, and hoarding cleanup services across its affluent and diverse residential market.",
            "asbestos-abatement": "Pasadena has an extensive inventory of pre-1980 historic housing with asbestos in popcorn ceilings, floor tiles, pipe insulation, and drywall compound. Every major restoration project in older Pasadena homes requires asbestos assessment.",
            "general-contractor": "Pasadena's historic housing stock, high property values, and extreme wildfire exposure create strong demand for licensed general contractors managing insurance reconstruction to premium standards.",
        }
    },
    "orange-ca": {
        "city": "Orange", "state": "California", "abbrev": "CA",
        "context": {
            "water-damage": "Orange's Orange County location experiences atmospheric river flooding events that cause water intrusion in residential neighborhoods. The city's older historic downtown housing is particularly vulnerable to water damage during wet season events.",
            "fire-damage": "Orange's position in Orange County creates exposure to Santa Ana wind-driven fire conditions. The city's hillside and canyon areas face elevated wildfire risk during dry season wind events.",
            "mold-remediation": "Orange's older housing stock and periodic water intrusion events create mold risk. Post-water damage mold grows quickly in Southern California's mild climate if not immediately remediated.",
            "storm-damage": "Orange experiences atmospheric river events and Santa Ana wind conditions that cause flooding, roof damage, and structural impacts throughout the city and surrounding Orange County.",
            "biohazard-cleanup": "Orange has consistent demand for biohazard, unattended death, and hoarding cleanup services across its residential and commercial market in central Orange County.",
            "asbestos-abatement": "Orange has a substantial inventory of pre-1980 housing with asbestos in popcorn ceilings, floor tiles, pipe insulation, and drywall compound throughout its established residential neighborhoods.",
            "general-contractor": "Orange's residential market and exposure to water, fire, and storm damage events create strong demand for licensed general contractors handling insurance reconstruction throughout Orange County.",
        }
    },
    "fullerton-ca": {
        "city": "Fullerton", "state": "California", "abbrev": "CA",
        "context": {
            "water-damage": "Fullerton's North Orange County location experiences atmospheric river flooding events that cause water intrusion in older residential neighborhoods. The city's aging housing stock is vulnerable to pipe failures during wet season events.",
            "fire-damage": "Fullerton's hillside areas and proximity to the Santa Ana Mountains create wildfire risk during Santa Ana wind events. Wind-driven fire conditions threaten hillside residential neighborhoods.",
            "mold-remediation": "Fullerton's older, densely packed housing stock and periodic water intrusion events create significant mold risk. Post-water damage mold grows rapidly in Southern California's mild climate.",
            "storm-damage": "Fullerton experiences atmospheric river events and Santa Ana wind conditions that cause flooding, roof damage, and structural impacts in residential neighborhoods throughout North Orange County.",
            "biohazard-cleanup": "Fullerton has consistent demand for biohazard, unattended death, and hoarding cleanup services across its large residential and Cal State Fullerton-adjacent market.",
            "asbestos-abatement": "Fullerton has an extensive inventory of pre-1980 housing with asbestos in popcorn ceilings, floor tiles, pipe insulation, and drywall compound throughout its established residential neighborhoods.",
            "general-contractor": "Fullerton's large residential market and exposure to water, fire, and storm damage events create strong demand for licensed general contractors handling insurance reconstruction throughout Orange County.",
        }
    },
    "visalia-ca": {
        "city": "Visalia", "state": "California", "abbrev": "CA",
        "context": {
            "water-damage": "Visalia's San Joaquin Valley location brings atmospheric river flooding events that cause flooding and water intrusion in residential neighborhoods. The city's large stock of older housing is vulnerable to pipe failures during cold winter freezes.",
            "fire-damage": "Visalia sits at the gateway to the Sequoia National Forest and Sierra Nevada foothills with significant wildfire exposure. Surrounding foothill communities and the Giant Sequoia National Monument create fire risk during California's dry season.",
            "mold-remediation": "Visalia's periodic flooding and hot Central Valley summers create mold risk in older homes. Post-water damage mold grows rapidly in extreme heat if remediation is delayed.",
            "storm-damage": "Visalia experiences atmospheric river flooding and wind events that cause significant damage in low-lying residential neighborhoods. Valley floor flooding during major rain events creates water damage risk.",
            "biohazard-cleanup": "Visalia has consistent demand for biohazard, unattended death, and hoarding cleanup services as Tulare County's largest city.",
            "asbestos-abatement": "Visalia has a large inventory of pre-1980 housing with asbestos in popcorn ceilings, floor tiles, pipe insulation, and drywall compound throughout its established residential neighborhoods.",
            "general-contractor": "Visalia's large residential market and exposure to fire, flood, and storm damage events create strong demand for licensed general contractors handling insurance reconstruction throughout the Central Valley.",
        }
    },
    "victorville-ca": {
        "city": "Victorville", "state": "California", "abbrev": "CA",
        "context": {
            "water-damage": "Victorville's high desert location brings cold winters with hard freezes that cause pipe bursts. Periodic atmospheric river events cause flooding in low-lying areas of the Mojave River basin. The city's large residential base faces water damage risk.",
            "fire-damage": "Victorville sits in the high desert with significant wildfire risk during California's dry and windy season. Surrounding desert scrub creates fire exposure for residential properties throughout the Victor Valley.",
            "mold-remediation": "While Victorville is dry, pipe burst events and periodic flooding create localized moisture conditions that lead to mold growth if not addressed immediately. Older homes in the Victor Valley are common mold sites.",
            "storm-damage": "Victorville experiences wind events, dust storms, and occasional heavy rain that cause roof and structural damage. The high desert's open geography amplifies wind impacts throughout the Victor Valley.",
            "biohazard-cleanup": "Victorville has consistent demand for biohazard, unattended death, and hoarding cleanup services as the Victor Valley's largest city and regional hub.",
            "asbestos-abatement": "Victorville has older residential areas with pre-1980 housing containing asbestos in popcorn ceilings, floor tiles, and pipe insulation alongside newer construction.",
            "general-contractor": "Victorville's large residential market creates strong demand for licensed general contractors handling insurance reconstruction after fire, water, and wind damage events in the Victor Valley.",
        }
    },
    "santa-rosa-ca": {
        "city": "Santa Rosa", "state": "California", "abbrev": "CA",
        "context": {
            "water-damage": "Santa Rosa's North Bay location receives significant winter rainfall and experiences atmospheric river events that cause flooding and water intrusion. The city's older housing stock is particularly vulnerable to water damage during wet season events.",
            "fire-damage": "Santa Rosa was devastated by the 2017 Tubbs Fire, which destroyed thousands of homes in the city. The North Bay remains an extremely high wildfire risk zone. Wind-driven fires have repeatedly threatened Santa Rosa neighborhoods, making this one of California's highest-risk markets.",
            "mold-remediation": "Santa Rosa's wet winters and periodic flooding create significant mold risk in older homes. Post-fire reconstruction has created new mold risks in homes with improper moisture management during rebuilding.",
            "storm-damage": "Santa Rosa experiences atmospheric river events and North Bay wind storms that cause flooding, roof damage, and structural impacts throughout Sonoma County.",
            "biohazard-cleanup": "Santa Rosa has consistent demand for biohazard, unattended death, and hoarding cleanup services as Sonoma County's largest city.",
            "asbestos-abatement": "Santa Rosa has a large inventory of pre-1980 housing with asbestos in popcorn ceilings, floor tiles, pipe insulation, and drywall compound. Post-fire reconstruction frequently requires asbestos assessment in older properties.",
            "general-contractor": "Santa Rosa's fire history, ongoing wildfire risk, and large residential market create one of Northern California's strongest demands for licensed general contractors managing insurance reconstruction.",
        }
    },
    "el-monte-ca": {
        "city": "El Monte", "state": "California", "abbrev": "CA",
        "context": {
            "water-damage": "El Monte's San Gabriel Valley location experiences atmospheric river flooding events that cause water intrusion in older residential neighborhoods. The Rio Hondo and San Gabriel River create flood risk for low-lying properties.",
            "fire-damage": "El Monte's San Gabriel Valley location creates exposure to Santa Ana wind-driven fire conditions. The city's older housing stock carries elevated fire risk from aging electrical systems.",
            "mold-remediation": "El Monte's older, densely packed housing stock and periodic water intrusion events create significant mold risk. Post-water damage mold grows rapidly in Southern California's mild climate.",
            "storm-damage": "El Monte experiences atmospheric river events and Santa Ana wind conditions that cause flooding, roof damage, and structural impacts in residential neighborhoods throughout the San Gabriel Valley.",
            "biohazard-cleanup": "El Monte has significant demand for biohazard, unattended death, and hoarding cleanup services across its densely populated urban residential market.",
            "asbestos-abatement": "El Monte has an extensive inventory of pre-1980 housing with asbestos in popcorn ceilings, floor tiles, pipe insulation, and drywall compound. The city's older housing stock frequently requires asbestos testing and abatement.",
            "general-contractor": "El Monte's large residential market and exposure to water, fire, and storm damage events create strong demand for licensed general contractors handling insurance reconstruction.",
        }
    },
    "thousand-oaks-ca": {
        "city": "Thousand Oaks", "state": "California", "abbrev": "CA",
        "context": {
            "water-damage": "Thousand Oaks's Conejo Valley location experiences atmospheric river flooding events. The city's older residential areas face water intrusion risk during wet season events, and hillside properties face erosion and water damage following wildfires.",
            "fire-damage": "Thousand Oaks was devastated by the 2018 Woolsey Fire, which destroyed hundreds of homes in the city and surrounding communities. The city remains in an extreme wildfire risk zone with ongoing exposure during Santa Ana wind events.",
            "mold-remediation": "Thousand Oaks's periodic flooding and post-fire reconstruction activity create mold risk. Post-water damage mold grows quickly in the mild climate if not immediately remediated.",
            "storm-damage": "Thousand Oaks experiences atmospheric river events and Santa Ana wind conditions that cause flooding, roof damage, and mudslides in hillside neighborhoods throughout Ventura County.",
            "biohazard-cleanup": "Thousand Oaks has consistent demand for biohazard, unattended death, and hoarding cleanup services across its affluent residential market.",
            "asbestos-abatement": "Thousand Oaks has older residential areas with pre-1980 housing containing asbestos in popcorn ceilings, floor tiles, and pipe insulation. Post-fire reconstruction in older areas requires asbestos assessment.",
            "general-contractor": "Thousand Oaks's fire history, extreme wildfire risk, and large residential market create strong demand for licensed general contractors managing insurance reconstruction after fire, water, and storm damage events.",
        }
    },
    "simi-valley-ca": {
        "city": "Simi Valley", "state": "California", "abbrev": "CA",
        "context": {
            "water-damage": "Simi Valley's location in the Simi Valley corridor experiences atmospheric river flooding events. The city's mix of older and newer housing is vulnerable to water intrusion during wet season events.",
            "fire-damage": "Simi Valley sits in a high wildfire risk zone in Ventura County. Santa Ana wind-driven fires have repeatedly threatened Simi Valley neighborhoods. The city's proximity to the Santa Susana Mountains creates ongoing extreme fire exposure.",
            "mold-remediation": "Simi Valley's periodic flooding and warm inland climate create mold risk following water damage events. Post-water damage mold grows quickly in the mild climate if not immediately remediated.",
            "storm-damage": "Simi Valley experiences atmospheric river events and Santa Ana wind conditions that cause flooding, roof damage, and structural impacts in residential neighborhoods.",
            "biohazard-cleanup": "Simi Valley has consistent demand for biohazard, unattended death, and hoarding cleanup services across its large residential market in Ventura County.",
            "asbestos-abatement": "Simi Valley has older residential areas with pre-1980 housing containing asbestos in popcorn ceilings, floor tiles, and pipe insulation alongside newer construction.",
            "general-contractor": "Simi Valley's large residential market and extreme wildfire exposure create strong demand for licensed general contractors handling insurance reconstruction after fire, water, and storm damage events.",
        }
    },
    "concord-ca": {
        "city": "Concord", "state": "California", "abbrev": "CA",
        "context": {
            "water-damage": "Concord's East Bay location experiences atmospheric river flooding events that cause water intrusion in residential neighborhoods. The city's older housing stock is vulnerable to pipe failures and water damage during wet season events.",
            "fire-damage": "Concord's hillside areas and proximity to the Diablo Range create wildfire risk during dry season Diablo wind events. East Bay hills fires have threatened Concord area neighborhoods.",
            "mold-remediation": "Concord's Bay Area climate and older housing stock create persistent mold risk in crawl spaces and wall cavities. Post-water damage mold is a common issue in the city's established residential neighborhoods.",
            "storm-damage": "Concord experiences atmospheric river events and wind storms that cause flooding, roof damage, and structural impacts throughout Contra Costa County.",
            "biohazard-cleanup": "Concord has consistent demand for biohazard, unattended death, and hoarding cleanup services across its large residential market in Contra Costa County.",
            "asbestos-abatement": "Concord has a substantial inventory of pre-1980 housing with asbestos in popcorn ceilings, floor tiles, pipe insulation, and drywall compound throughout its established residential neighborhoods.",
            "general-contractor": "Concord's large residential market and exposure to fire, flood, and storm damage events create strong demand for licensed general contractors managing insurance reconstruction throughout the East Bay.",
        }
    },
    "roseville-ca": {
        "city": "Roseville", "state": "California", "abbrev": "CA",
        "context": {
            "water-damage": "Roseville's Sacramento Valley location brings atmospheric river events that create flooding risk. The city's rapidly growing residential base includes both older and newer housing vulnerable to water intrusion and pipe failures.",
            "fire-damage": "Roseville sits at the base of the Sierra Nevada foothills with wildfire exposure during California's dry season. Surrounding foothill communities and the Placer County interface create ongoing fire risk.",
            "mold-remediation": "Roseville's periodic flooding and hot Sacramento Valley summers create mold risk in older homes. Post-water damage mold grows rapidly in extreme heat if remediation is delayed.",
            "storm-damage": "Roseville experiences atmospheric river events and valley wind storms that cause flooding, roof damage, and structural impacts throughout the Sacramento region.",
            "biohazard-cleanup": "Roseville has consistent demand for biohazard, unattended death, and hoarding cleanup services as one of the Sacramento region's fastest-growing cities.",
            "asbestos-abatement": "Roseville has older residential areas with pre-1980 housing containing asbestos in popcorn ceilings, floor tiles, and pipe insulation alongside newer construction in master-planned communities.",
            "general-contractor": "Roseville's large and growing residential market and wildfire exposure create strong demand for licensed general contractors handling insurance reconstruction after fire, water, and storm damage events.",
        }
    },
    "vallejo-ca": {
        "city": "Vallejo", "state": "California", "abbrev": "CA",
        "context": {
            "water-damage": "Vallejo's Solano County location on San Pablo Bay experiences atmospheric river flooding events and tidal flooding. The city's large stock of older housing is vulnerable to water intrusion and pipe failures during wet season events.",
            "fire-damage": "Vallejo's hillside neighborhoods and proximity to the Napa and Sonoma wildfire zones create significant fire risk. North Bay wildfires have created smoke and ember intrusion risk for Vallejo properties.",
            "mold-remediation": "Vallejo's coastal Bay Area climate and older housing stock create persistent mold risk in crawl spaces and wall cavities. Post-water damage mold is a common issue in the city's established residential neighborhoods.",
            "storm-damage": "Vallejo experiences atmospheric river events and wind storms that cause flooding, roof damage, and structural impacts. The city's waterfront location amplifies storm impacts.",
            "biohazard-cleanup": "Vallejo has significant demand for biohazard, unattended death, crime scene, and hoarding cleanup services across its diverse urban residential market.",
            "asbestos-abatement": "Vallejo has an extensive inventory of pre-1980 housing with asbestos in popcorn ceilings, floor tiles, pipe insulation, and drywall compound. The city's older housing stock frequently requires asbestos testing and abatement.",
            "general-contractor": "Vallejo's large residential market and ongoing exposure to water, fire, and storm damage events create strong demand for licensed general contractors managing insurance reconstruction.",
        }
    },
    "elk-grove-ca": {
        "city": "Elk Grove", "state": "California", "abbrev": "CA",
        "context": {
            "water-damage": "Elk Grove's Sacramento area location brings atmospheric river flooding risk. The city's rapidly growing residential base includes both older and newer housing vulnerable to water intrusion and pipe failures during wet season events.",
            "fire-damage": "Elk Grove sits south of Sacramento with wildfire exposure from surrounding agricultural and foothill areas during California's dry season. Smoke intrusion from regional wildfires affects properties throughout the city.",
            "mold-remediation": "Elk Grove's periodic flooding and hot Sacramento Valley summers create mold risk in older homes. Post-water damage mold grows rapidly in extreme heat if remediation is delayed.",
            "storm-damage": "Elk Grove experiences atmospheric river flooding and valley wind storms that cause flooding, roof damage, and structural impacts throughout the Sacramento region.",
            "biohazard-cleanup": "Elk Grove has consistent demand for biohazard, unattended death, and hoarding cleanup services as one of the Sacramento region's fastest-growing cities.",
            "asbestos-abatement": "Elk Grove has older residential areas with pre-1980 housing containing asbestos in popcorn ceilings, floor tiles, and pipe insulation alongside newer construction.",
            "general-contractor": "Elk Grove's large and growing residential market creates strong demand for licensed general contractors handling insurance reconstruction after water, fire, and storm damage events.",
        }
    },
    "rancho-cucamonga-ca": {
        "city": "Rancho Cucamonga", "state": "California", "abbrev": "CA",
        "context": {
            "water-damage": "Rancho Cucamonga's Inland Empire location experiences atmospheric river flooding events and debris flows from the San Gabriel Mountains. The city's residential areas face significant water intrusion risk during wet season events.",
            "fire-damage": "Rancho Cucamonga sits at the foot of the San Gabriel Mountains with extreme wildfire risk during Santa Ana wind events. Wind-driven fires have repeatedly threatened Rancho Cucamonga neighborhoods. This is one of the Inland Empire's highest fire risk areas.",
            "mold-remediation": "Rancho Cucamonga's periodic flooding and hot Inland Empire summers create mold risk in older homes. Post-water damage mold grows rapidly in extreme heat if remediation is not immediate.",
            "storm-damage": "Rancho Cucamonga experiences atmospheric river events, Santa Ana wind conditions, and mountain debris flows that cause flooding, roof damage, and structural impacts.",
            "biohazard-cleanup": "Rancho Cucamonga has consistent demand for biohazard, unattended death, and hoarding cleanup services across its large residential market in the western Inland Empire.",
            "asbestos-abatement": "Rancho Cucamonga has older residential neighborhoods with pre-1980 housing containing asbestos in popcorn ceilings, floor tiles, pipe insulation, and drywall compound.",
            "general-contractor": "Rancho Cucamonga's large residential market and extreme wildfire exposure create strong demand for licensed general contractors handling insurance reconstruction after fire, water, and storm damage events.",
        }
    },
    "ontario-ca": {
        "city": "Ontario", "state": "California", "abbrev": "CA",
        "context": {
            "water-damage": "Ontario's Inland Empire location experiences atmospheric river flooding events that cause water intrusion in residential neighborhoods. The Santa Ana River creates flood risk. Cold winter temperatures cause pipe bursts in older housing.",
            "fire-damage": "Ontario sits in the Inland Empire with exposure to Santa Ana wind-driven fire conditions. The surrounding foothills and industrial-residential mix create diverse fire risk profiles throughout the city.",
            "mold-remediation": "Ontario's periodic flooding and hot Inland Empire summers create mold risk in older homes. Post-water damage mold grows rapidly in extreme heat if remediation is not immediate.",
            "storm-damage": "Ontario experiences atmospheric river events and Santa Ana wind conditions that cause flooding, roof damage, and structural impacts throughout the Inland Empire.",
            "biohazard-cleanup": "Ontario has consistent demand for biohazard, unattended death, and hoarding cleanup services as a major Inland Empire commercial and residential hub.",
            "asbestos-abatement": "Ontario has older residential neighborhoods with pre-1980 housing containing asbestos in popcorn ceilings, floor tiles, pipe insulation, and drywall compound.",
            "general-contractor": "Ontario's large residential market and exposure to fire, flood, and storm damage events create strong demand for licensed general contractors handling insurance reconstruction throughout the Inland Empire.",
        }
    },
    "santa-clara-ca": {
        "city": "Santa Clara", "state": "California", "abbrev": "CA",
        "context": {
            "water-damage": "Santa Clara's Silicon Valley location experiences atmospheric river flooding events. The city's older housing stock is vulnerable to water intrusion and pipe failures during wet season events.",
            "fire-damage": "Santa Clara sits adjacent to the Santa Cruz Mountains and Diablo Range with wildfire risk during dry season wind events. The city's tech corridor and residential areas face fire exposure during Diablo wind conditions.",
            "mold-remediation": "Santa Clara's older housing stock and periodic flooding events create significant mold risk. Silicon Valley's high-value real estate market demands professional mold remediation to protect property values.",
            "storm-damage": "Santa Clara experiences atmospheric river events and wind-driven storms that cause flooding, roof damage, and structural impacts throughout the Santa Clara Valley.",
            "biohazard-cleanup": "Santa Clara has consistent demand for biohazard, unattended death, and hoarding cleanup services across its large residential and tech-adjacent market.",
            "asbestos-abatement": "Santa Clara has a significant inventory of pre-1980 housing with asbestos in popcorn ceilings, floor tiles, pipe insulation, and drywall compound. Silicon Valley's renovation activity frequently requires asbestos abatement.",
            "general-contractor": "Santa Clara's high-value real estate market and ongoing exposure to fire, flood, and storm events create strong demand for licensed general contractors managing insurance reconstruction.",
        }
    },
    "downey-ca": {
        "city": "Downey", "state": "California", "abbrev": "CA",
        "context": {
            "water-damage": "Downey's Los Angeles County location experiences atmospheric river flooding events that cause water intrusion in older residential neighborhoods. The city's large stock of mid-century housing is vulnerable to water damage during wet season events.",
            "fire-damage": "Downey's older residential neighborhoods contain aging housing stock with elevated fire risk from outdated electrical systems. Wind-driven fire conditions during Santa Ana events create fire risk throughout the area.",
            "mold-remediation": "Downey's older, densely packed housing stock and periodic water intrusion events create significant mold risk. Post-water damage mold grows rapidly in Southern California's mild climate.",
            "storm-damage": "Downey experiences atmospheric river events and Santa Ana wind conditions that cause flooding, roof damage, and structural impacts in residential neighborhoods.",
            "biohazard-cleanup": "Downey has significant demand for biohazard, unattended death, and hoarding cleanup services across its large urban residential market in southeast Los Angeles County.",
            "asbestos-abatement": "Downey has an extensive inventory of pre-1980 housing with asbestos in popcorn ceilings, floor tiles, pipe insulation, and drywall compound throughout its established residential neighborhoods.",
            "general-contractor": "Downey's large residential market and ongoing exposure to water, fire, and storm damage events create strong demand for licensed general contractors managing insurance reconstruction.",
        }
    },
    "costa-mesa-ca": {
        "city": "Costa Mesa", "state": "California", "abbrev": "CA",
        "context": {
            "water-damage": "Costa Mesa's coastal Orange County location makes it subject to atmospheric river flooding and stormwater backup events. The city's older residential housing is vulnerable to water intrusion and pipe failures during wet season events.",
            "fire-damage": "Costa Mesa's older residential neighborhoods contain aging housing stock with elevated fire risk. Wind-driven fire conditions during Santa Ana events create fire risk throughout Orange County.",
            "mold-remediation": "Costa Mesa's coastal humidity and older housing stock create persistent mold risk in crawl spaces and wall cavities. Post-water damage mold grows quickly in the coastal climate.",
            "storm-damage": "Costa Mesa experiences atmospheric river events and Santa Ana wind conditions that cause flooding, roof damage, and structural impacts in residential neighborhoods.",
            "biohazard-cleanup": "Costa Mesa has consistent demand for biohazard, unattended death, and hoarding cleanup services across its residential and commercial market in central Orange County.",
            "asbestos-abatement": "Costa Mesa has a substantial inventory of pre-1980 housing with asbestos in popcorn ceilings, floor tiles, pipe insulation, and drywall compound throughout its established residential neighborhoods.",
            "general-contractor": "Costa Mesa's residential market and exposure to water, fire, and storm damage events create strong demand for licensed general contractors handling insurance reconstruction throughout Orange County.",
        }
    },
    "inglewood-ca": {
        "city": "Inglewood", "state": "California", "abbrev": "CA",
        "context": {
            "water-damage": "Inglewood's Los Angeles County location experiences atmospheric river flooding events that cause water intrusion in older residential neighborhoods. The city's large stock of older bungalows and mid-century housing is vulnerable to water damage.",
            "fire-damage": "Inglewood's older residential neighborhoods contain aging housing stock with elevated fire risk from outdated electrical systems. Wind-driven fire conditions during Santa Ana events create fire risk throughout the area.",
            "mold-remediation": "Inglewood's older, densely packed housing stock and periodic water intrusion events create significant mold risk. Post-water damage mold grows rapidly in Southern California's mild climate.",
            "storm-damage": "Inglewood experiences atmospheric river events and Santa Ana wind conditions that cause flooding, roof damage, and structural impacts in residential neighborhoods.",
            "biohazard-cleanup": "Inglewood has significant demand for biohazard, unattended death, crime scene, and hoarding cleanup services across its dense urban residential market.",
            "asbestos-abatement": "Inglewood has an extensive inventory of pre-1980 housing with asbestos in popcorn ceilings, floor tiles, pipe insulation, and drywall compound. Every major restoration project in older Inglewood homes requires asbestos assessment.",
            "general-contractor": "Inglewood's large residential market and ongoing exposure to water, fire, and storm damage events create strong demand for licensed general contractors managing insurance reconstruction.",
        }
    },
    "west-covina-ca": {
        "city": "West Covina", "state": "California", "abbrev": "CA",
        "context": {
            "water-damage": "West Covina's San Gabriel Valley location experiences atmospheric river flooding events that cause water intrusion in older residential neighborhoods. The city's aging housing stock is vulnerable to water damage during wet season events.",
            "fire-damage": "West Covina's hillside areas and proximity to the San Gabriel Mountains create wildfire risk during Santa Ana wind events. Wind-driven fires have threatened West Covina neighborhoods.",
            "mold-remediation": "West Covina's older housing stock and periodic water intrusion events create mold risk. Post-water damage mold grows quickly in Southern California's mild climate if not immediately remediated.",
            "storm-damage": "West Covina experiences atmospheric river events and Santa Ana wind conditions that cause flooding, roof damage, and structural impacts in residential neighborhoods throughout the San Gabriel Valley.",
            "biohazard-cleanup": "West Covina has consistent demand for biohazard, unattended death, and hoarding cleanup services across its large residential market in the San Gabriel Valley.",
            "asbestos-abatement": "West Covina has a substantial inventory of pre-1980 housing with asbestos in popcorn ceilings, floor tiles, pipe insulation, and drywall compound throughout its established residential neighborhoods.",
            "general-contractor": "West Covina's large residential market and exposure to water, fire, and storm damage events create strong demand for licensed general contractors handling insurance reconstruction.",
        }
    },
    "norwalk-ca": {
        "city": "Norwalk", "state": "California", "abbrev": "CA",
        "context": {
            "water-damage": "Norwalk's Los Angeles County location experiences atmospheric river flooding events that cause water intrusion in older residential neighborhoods. The city's large stock of older housing is particularly vulnerable to water damage.",
            "fire-damage": "Norwalk's older residential neighborhoods contain aging housing stock with elevated fire risk from outdated electrical systems. Wind-driven fire conditions during Santa Ana events create fire risk throughout the area.",
            "mold-remediation": "Norwalk's older, densely packed housing stock and periodic water intrusion events create significant mold risk. Post-water damage mold grows rapidly in Southern California's mild climate.",
            "storm-damage": "Norwalk experiences atmospheric river events and Santa Ana wind conditions that cause flooding, roof damage, and structural impacts in residential neighborhoods.",
            "biohazard-cleanup": "Norwalk has significant demand for biohazard, unattended death, and hoarding cleanup services across its densely populated urban residential market in southeast Los Angeles County.",
            "asbestos-abatement": "Norwalk has an extensive inventory of pre-1980 housing with asbestos in popcorn ceilings, floor tiles, pipe insulation, and drywall compound throughout its established residential neighborhoods.",
            "general-contractor": "Norwalk's large residential market and ongoing exposure to water, fire, and storm damage events create strong demand for licensed general contractors managing insurance reconstruction.",
        }
    },
    "burbank-ca": {
        "city": "Burbank", "state": "California", "abbrev": "CA",
        "context": {
            "water-damage": "Burbank's San Fernando Valley location experiences atmospheric river flooding events that cause water intrusion in residential neighborhoods. The city's older housing stock is vulnerable to water damage during wet season events.",
            "fire-damage": "Burbank borders the Verdugo Mountains and sits adjacent to Angeles National Forest with extreme wildfire risk during Santa Ana wind events. Hillside neighborhoods face significant ongoing fire exposure.",
            "mold-remediation": "Burbank's older housing stock and periodic flooding events create mold risk. Post-water damage mold grows quickly in Southern California's mild climate if not immediately remediated.",
            "storm-damage": "Burbank experiences atmospheric river events and Santa Ana wind conditions that cause flooding, roof damage, and debris flows from the Verdugo Mountains.",
            "biohazard-cleanup": "Burbank has consistent demand for biohazard, unattended death, and hoarding cleanup services across its residential and media industry-adjacent market.",
            "asbestos-abatement": "Burbank has a substantial inventory of pre-1980 housing and commercial buildings with asbestos in popcorn ceilings, floor tiles, pipe insulation, and drywall compound.",
            "general-contractor": "Burbank's residential market and wildfire exposure create strong demand for licensed general contractors handling insurance reconstruction after fire, water, and storm damage events.",
        }
    },
    "el-cajon-ca": {
        "city": "El Cajon", "state": "California", "abbrev": "CA",
        "context": {
            "water-damage": "El Cajon's inland San Diego County location experiences atmospheric river flooding events. The city's older housing stock is vulnerable to water intrusion and pipe failures during wet season events.",
            "fire-damage": "El Cajon sits in one of San Diego County's highest wildfire risk areas. Santa Ana wind-driven fires have repeatedly threatened El Cajon neighborhoods. The city's proximity to backcountry areas creates significant ongoing fire exposure.",
            "mold-remediation": "El Cajon's periodic flooding and warm inland climate create mold risk following water damage events. Post-water damage mold grows quickly in the mild climate if not immediately remediated.",
            "storm-damage": "El Cajon experiences atmospheric river events and Santa Ana wind conditions that cause flooding, roof damage, and mudslides in hillside neighborhoods.",
            "biohazard-cleanup": "El Cajon has consistent demand for biohazard, unattended death, and hoarding cleanup services as one of San Diego County's largest inland cities.",
            "asbestos-abatement": "El Cajon has older residential neighborhoods with pre-1980 housing containing asbestos in popcorn ceilings, floor tiles, and pipe insulation.",
            "general-contractor": "El Cajon's residential market and wildfire exposure create strong demand for licensed general contractors handling insurance reconstruction after fire, water, and storm damage events in east San Diego County.",
        }
    },
    "richmond-ca": {
        "city": "Richmond", "state": "California", "abbrev": "CA",
        "context": {
            "water-damage": "Richmond's waterfront Bay Area location makes it subject to atmospheric river flooding and tidal flooding events. The city's older industrial and residential housing stock is vulnerable to water intrusion and pipe failures.",
            "fire-damage": "Richmond's hillside neighborhoods and proximity to the East Bay hills create wildfire risk during dry season Diablo wind events. The city's older housing stock also carries elevated fire risk from aging electrical systems.",
            "mold-remediation": "Richmond's Bay Area coastal climate and older housing stock create persistent mold risk in crawl spaces and wall cavities. Post-water damage mold is a common issue in the city's established residential neighborhoods.",
            "storm-damage": "Richmond experiences atmospheric river events and wind storms that cause flooding, roof damage, and structural impacts. The city's waterfront location amplifies storm impacts.",
            "biohazard-cleanup": "Richmond has significant demand for biohazard, unattended death, crime scene, and hoarding cleanup services across its diverse urban residential market.",
            "asbestos-abatement": "Richmond has an extensive inventory of pre-1980 housing and industrial buildings with asbestos in popcorn ceilings, floor tiles, pipe insulation, and drywall compound.",
            "general-contractor": "Richmond's large residential market and ongoing exposure to water, fire, and storm damage events create strong demand for licensed general contractors managing insurance reconstruction throughout the East Bay.",
        }
    },
    "murrieta-ca": {
        "city": "Murrieta", "state": "California", "abbrev": "CA",
        "context": {
            "water-damage": "Murrieta's southwest Riverside County location experiences atmospheric river flooding events. The city's rapidly growing residential base includes both older and newer housing vulnerable to water intrusion and pipe failures.",
            "fire-damage": "Murrieta sits in southwest Riverside County with significant wildfire risk during Santa Ana wind events. The city's wildland-urban interface and surrounding chaparral create ongoing fire exposure for residential developments.",
            "mold-remediation": "Murrieta's periodic flooding and warm inland climate create mold risk following water damage events. Post-water damage mold grows quickly in the mild climate if not immediately remediated.",
            "storm-damage": "Murrieta experiences atmospheric river events and Santa Ana wind conditions that cause flooding, roof damage, and structural impacts throughout southwest Riverside County.",
            "biohazard-cleanup": "Murrieta has consistent demand for biohazard, unattended death, and hoarding cleanup services as one of the Inland Empire's fastest-growing cities.",
            "asbestos-abatement": "Murrieta has older residential areas with pre-1980 housing containing asbestos in popcorn ceilings, floor tiles, and pipe insulation alongside newer construction.",
            "general-contractor": "Murrieta's large and growing residential market creates strong demand for licensed general contractors handling insurance reconstruction after fire, water, and storm damage events.",
        }
    },
    "antioch-ca": {
        "city": "Antioch", "state": "California", "abbrev": "CA",
        "context": {
            "water-damage": "Antioch's Sacramento-San Joaquin Delta location creates significant flood risk during atmospheric river events. The city's proximity to the Delta waterways creates ongoing water intrusion exposure for properties throughout the area.",
            "fire-damage": "Antioch's East Bay location and proximity to Mount Diablo create wildfire risk during dry season Diablo wind events. The city's residential areas face fire exposure during hot dry summers.",
            "mold-remediation": "Antioch's Delta location, periodic flooding, and Bay Area climate create mold risk in older homes. Post-water damage mold is a common issue in the city's established residential neighborhoods.",
            "storm-damage": "Antioch experiences atmospheric river flooding and wind events that cause significant damage in low-lying residential neighborhoods near the Delta.",
            "biohazard-cleanup": "Antioch has consistent demand for biohazard, unattended death, and hoarding cleanup services across its large residential market in eastern Contra Costa County.",
            "asbestos-abatement": "Antioch has a substantial inventory of pre-1980 housing with asbestos in popcorn ceilings, floor tiles, pipe insulation, and drywall compound throughout its established residential neighborhoods.",
            "general-contractor": "Antioch's large residential market and exposure to flood and storm damage events create strong demand for licensed general contractors handling insurance reconstruction.",
        }
    },
    "temecula-ca": {
        "city": "Temecula", "state": "California", "abbrev": "CA",
        "context": {
            "water-damage": "Temecula's southwest Riverside County location experiences atmospheric river flooding events. The Santa Margarita River creates flood risk for low-lying properties. The city's mix of older and newer housing faces water damage risk.",
            "fire-damage": "Temecula sits in southwest Riverside County with significant wildfire risk during Santa Ana wind events. The surrounding wine country and chaparral create ongoing fire exposure for Temecula's residential developments.",
            "mold-remediation": "Temecula's periodic flooding and warm inland climate create mold risk following water damage events. High-value wine country homes require professional mold remediation to protect significant property values.",
            "storm-damage": "Temecula experiences atmospheric river events and Santa Ana wind conditions that cause flooding, roof damage, and structural impacts throughout southwest Riverside County.",
            "biohazard-cleanup": "Temecula has consistent demand for biohazard, unattended death, and hoarding cleanup services across its growing residential and wine country market.",
            "asbestos-abatement": "Temecula has older residential areas with pre-1980 housing containing asbestos in popcorn ceilings, floor tiles, and pipe insulation alongside newer construction.",
            "general-contractor": "Temecula's growing residential market and wildfire exposure create strong demand for licensed general contractors handling insurance reconstruction after fire, water, and storm damage events.",
        }
    },
    "berkeley-ca": {
        "city": "Berkeley", "state": "California", "abbrev": "CA",
        "context": {
            "water-damage": "Berkeley's Bay Area location experiences atmospheric river flooding events and aging sewer infrastructure that causes backups in older neighborhoods. The city's large inventory of historic housing is particularly vulnerable to water damage.",
            "fire-damage": "Berkeley was devastated by the 1991 Tunnel Fire and remains in an extreme wildfire risk zone. The Berkeley Hills face severe fire risk during Diablo wind events. This is one of the Bay Area's highest wildfire risk communities.",
            "mold-remediation": "Berkeley's coastal fog, winter rainfall, and historic housing stock create persistent mold risk. Poor ventilation in older craftsman and Victorian homes allows mold to establish in wall cavities and crawl spaces.",
            "storm-damage": "Berkeley experiences atmospheric river events and Pacific windstorms that cause roof and structural damage throughout the city. Hillside neighborhoods face elevated storm exposure.",
            "biohazard-cleanup": "Berkeley has significant demand for biohazard, unattended death, crime scene, and hoarding cleanup services across its dense urban residential and university-adjacent market.",
            "asbestos-abatement": "Berkeley has an enormous inventory of pre-1980 historic housing with asbestos in popcorn ceilings, floor tiles, pipe insulation, and drywall compound. Every major restoration project in older Berkeley homes requires asbestos assessment.",
            "general-contractor": "Berkeley's historic housing stock, high property values, and extreme wildfire risk create one of the Bay Area's strongest demands for licensed general contractors managing insurance reconstruction.",
        }
    },
    "clovis-ca": {
        "city": "Clovis", "state": "California", "abbrev": "CA",
        "context": {
            "water-damage": "Clovis's San Joaquin Valley location brings atmospheric river flooding events that cause water intrusion in residential neighborhoods. The city's growing residential base includes both older and newer housing vulnerable to pipe failures during cold winter freezes.",
            "fire-damage": "Clovis sits at the base of the Sierra Nevada foothills with significant wildfire exposure. Surrounding foothill communities and the Sierra National Forest create fire risk during California's dry season.",
            "mold-remediation": "Clovis's periodic flooding and hot Central Valley summers create mold risk in older homes. Post-water damage mold grows rapidly in extreme heat if remediation is delayed.",
            "storm-damage": "Clovis experiences atmospheric river flooding and wind events that cause damage in residential neighborhoods. Valley floor flooding during major rain events creates water damage risk.",
            "biohazard-cleanup": "Clovis has consistent demand for biohazard, unattended death, and hoarding cleanup services as one of the fastest-growing cities in the Fresno metro area.",
            "asbestos-abatement": "Clovis has older residential areas with pre-1980 housing containing asbestos in popcorn ceilings, floor tiles, and pipe insulation alongside newer construction.",
            "general-contractor": "Clovis's growing residential market and wildfire exposure create strong demand for licensed general contractors handling insurance reconstruction after fire, water, and storm damage events.",
        }
    },
    "santa-maria-ca": {
        "city": "Santa Maria", "state": "California", "abbrev": "CA",
        "context": {
            "water-damage": "Santa Maria's Santa Barbara County location brings atmospheric river flooding events that cause water intrusion in residential neighborhoods. The Santa Maria River creates flood risk for low-lying properties.",
            "fire-damage": "Santa Maria sits near the Santa Ynez Mountains with wildfire exposure during California's dry season. Surrounding agricultural and foothill communities create fire risk, and Santa Ana wind conditions occasionally affect the region.",
            "mold-remediation": "Santa Maria's coastal proximity and periodic flooding events create mold risk in older homes. Post-water damage mold grows quickly in the mild coastal climate if not immediately remediated.",
            "storm-damage": "Santa Maria experiences atmospheric river events that cause flooding, roof damage, and structural impacts in residential neighborhoods throughout Santa Barbara County.",
            "biohazard-cleanup": "Santa Maria has consistent demand for biohazard, unattended death, and hoarding cleanup services as Santa Barbara County's largest city.",
            "asbestos-abatement": "Santa Maria has older residential areas with pre-1980 housing containing asbestos in popcorn ceilings, floor tiles, and pipe insulation.",
            "general-contractor": "Santa Maria's residential market and exposure to flood and storm damage events create demand for licensed general contractors handling insurance reconstruction throughout the Central Coast.",
        }
    },
    "san-mateo-ca": {
        "city": "San Mateo", "state": "California", "abbrev": "CA",
        "context": {
            "water-damage": "San Mateo's Peninsula location experiences atmospheric river flooding events that cause water intrusion in residential neighborhoods. The city's older housing stock is vulnerable to pipe failures and water damage during wet season events.",
            "fire-damage": "San Mateo's hillside areas and proximity to the Santa Cruz Mountains create wildfire risk during dry season wind events. Peninsula communities face fire exposure during Diablo wind conditions.",
            "mold-remediation": "San Mateo's Bay Area climate and older housing stock create persistent mold risk in crawl spaces and wall cavities. Post-water damage mold is a common issue in the city's established residential neighborhoods.",
            "storm-damage": "San Mateo experiences atmospheric river events and wind storms that cause flooding, roof damage, and structural impacts throughout San Mateo County.",
            "biohazard-cleanup": "San Mateo has consistent demand for biohazard, unattended death, and hoarding cleanup services across its large residential market on the Peninsula.",
            "asbestos-abatement": "San Mateo has a significant inventory of pre-1980 housing with asbestos in popcorn ceilings, floor tiles, pipe insulation, and drywall compound. Peninsula renovation activity frequently requires asbestos abatement.",
            "general-contractor": "San Mateo's high-value real estate market and ongoing exposure to fire, flood, and storm events create strong demand for licensed general contractors managing insurance reconstruction.",
        }
    },
    "jurupa-valley-ca": {
        "city": "Jurupa Valley", "state": "California", "abbrev": "CA",
        "context": {
            "water-damage": "Jurupa Valley's Inland Empire location experiences atmospheric river flooding events. The Santa Ana River and Jurupa Mountains create flood risk for low-lying properties. Cold winter temperatures cause pipe bursts in the city's housing stock.",
            "fire-damage": "Jurupa Valley sits in the Inland Empire with exposure to Santa Ana wind-driven fire conditions. The surrounding hills and rural-urban interface create fire exposure for residential developments.",
            "mold-remediation": "Jurupa Valley's periodic flooding and hot Inland Empire summers create mold risk in older homes. Post-water damage mold grows rapidly in extreme heat if remediation is not immediate.",
            "storm-damage": "Jurupa Valley experiences atmospheric river events and Santa Ana wind conditions that cause flooding, roof damage, and structural impacts throughout the Inland Empire.",
            "biohazard-cleanup": "Jurupa Valley has consistent demand for biohazard, unattended death, and hoarding cleanup services as one of Riverside County's growing communities.",
            "asbestos-abatement": "Jurupa Valley has older residential areas with pre-1980 housing containing asbestos in popcorn ceilings, floor tiles, and pipe insulation.",
            "general-contractor": "Jurupa Valley's residential market and exposure to fire, flood, and storm damage events create demand for licensed general contractors handling insurance reconstruction throughout the Inland Empire.",
        }
    },
    "daly-city-ca": {
        "city": "Daly City", "state": "California", "abbrev": "CA",
        "context": {
            "water-damage": "Daly City's coastal San Mateo County location experiences atmospheric river flooding and coastal wind-driven rain events. The city's large inventory of older row houses and mid-century homes is vulnerable to water intrusion and pipe failures.",
            "fire-damage": "Daly City's older residential neighborhoods contain aging housing stock with elevated fire risk from outdated electrical systems. Dense housing creates rapid fire spread risk.",
            "mold-remediation": "Daly City's coastal fog, winter rainfall, and dense older housing stock create persistent mold risk. Poor ventilation in tightly-packed row homes allows mold to establish quickly after water events.",
            "storm-damage": "Daly City experiences Pacific windstorms and atmospheric river events that cause roof and structural damage throughout the city. The exposed hilltop location amplifies wind impacts.",
            "biohazard-cleanup": "Daly City has significant demand for biohazard, unattended death, and hoarding cleanup services across its dense urban residential market.",
            "asbestos-abatement": "Daly City has an extensive inventory of pre-1980 housing with asbestos in popcorn ceilings, floor tiles, pipe insulation, and drywall compound. Every major restoration project in older Daly City homes requires asbestos assessment.",
            "general-contractor": "Daly City's large residential market and ongoing exposure to water, fire, and storm damage events create strong demand for licensed general contractors managing insurance reconstruction.",
        }
    },
    "rialto-ca": {
        "city": "Rialto", "state": "California", "abbrev": "CA",
        "context": {
            "water-damage": "Rialto's Inland Empire location experiences atmospheric river flooding events. Cold winter temperatures cause pipe bursts in the city's older housing stock. The Lytle Creek and Cajon Creek create additional flood exposure.",
            "fire-damage": "Rialto sits in the Inland Empire adjacent to the Cajon Pass with significant wildfire risk during Santa Ana wind events. The surrounding foothills and pass geography create ongoing fire exposure for Rialto's residential neighborhoods.",
            "mold-remediation": "Rialto's periodic flooding and hot Inland Empire summers create mold risk in older homes. Post-water damage mold grows rapidly in extreme heat if remediation is not immediate.",
            "storm-damage": "Rialto experiences atmospheric river events and Santa Ana wind conditions that cause flooding, roof damage, and structural impacts throughout the Inland Empire.",
            "biohazard-cleanup": "Rialto has consistent demand for biohazard, unattended death, and hoarding cleanup services across its large residential market in San Bernardino County.",
            "asbestos-abatement": "Rialto has older residential neighborhoods with pre-1980 housing containing asbestos in popcorn ceilings, floor tiles, pipe insulation, and drywall compound.",
            "general-contractor": "Rialto's residential market and exposure to fire, flood, and storm damage events create demand for licensed general contractors handling insurance reconstruction throughout the Inland Empire.",
        }
    },
    "ventura-ca": {
        "city": "Ventura", "state": "California", "abbrev": "CA",
        "context": {
            "water-damage": "Ventura's coastal location makes it subject to atmospheric river flooding and storm surge events. The Santa Clara River creates significant flood risk for low-lying properties throughout the city.",
            "fire-damage": "Ventura was devastated by the 2017 Thomas Fire, the largest fire in California history at the time. The city remains in an extreme wildfire risk zone with ongoing Santa Ana wind-driven fire exposure. This is one of California's highest fire risk coastal communities.",
            "mold-remediation": "Ventura's coastal humidity and older housing stock create persistent mold risk. Post-fire reconstruction has also created new mold risks in homes with improper moisture management during rebuilding.",
            "storm-damage": "Ventura experiences atmospheric river events and Santa Ana wind conditions that cause flooding, coastal damage, roof damage, and structural impacts throughout Ventura County.",
            "biohazard-cleanup": "Ventura has consistent demand for biohazard, unattended death, and hoarding cleanup services as Ventura County's second largest city.",
            "asbestos-abatement": "Ventura has a substantial inventory of pre-1980 housing with asbestos in popcorn ceilings, floor tiles, pipe insulation, and drywall compound. Post-fire reconstruction in older areas requires asbestos assessment.",
            "general-contractor": "Ventura's fire history, extreme wildfire risk, and large residential market create one of Southern California's strongest demands for licensed general contractors managing insurance reconstruction.",
        }
    },
    "fairfield-ca": {
        "city": "Fairfield", "state": "California", "abbrev": "CA",
        "context": {
            "water-damage": "Fairfield's Solano County location brings atmospheric river flooding events that cause water intrusion in residential neighborhoods. The city's growing residential base includes both older and newer housing vulnerable to water damage.",
            "fire-damage": "Fairfield sits between the North Bay wildfire zones and the Sacramento Valley with wildfire exposure during California's dry season. Travis Air Force Base adjacency creates a large residential market with diverse restoration needs.",
            "mold-remediation": "Fairfield's periodic flooding and Bay Area climate create mold risk in older homes. Post-water damage mold is a common issue in the city's established residential neighborhoods.",
            "storm-damage": "Fairfield experiences atmospheric river events and valley wind storms that cause flooding, roof damage, and structural impacts throughout Solano County.",
            "biohazard-cleanup": "Fairfield has consistent demand for biohazard, unattended death, and hoarding cleanup services as Solano County's largest city near Travis Air Force Base.",
            "asbestos-abatement": "Fairfield has older residential areas with pre-1980 housing containing asbestos in popcorn ceilings, floor tiles, and pipe insulation alongside newer construction.",
            "general-contractor": "Fairfield's growing residential market creates strong demand for licensed general contractors handling insurance reconstruction after water, fire, and storm damage events throughout Solano County.",
        }
    },
}
...
def build_national_page(svc_key):
    ...
    # JSON-LD (FIXED: json.dumps instead of repr)
    faq_schema = "\n".join([
...
{faq_schema}
    ...
    damage_cards = "\n".join([f'<div class="damage-card"><div class="icon">{icon}</div><h4>{label}</h4></div>' for icon, label in s["damage_types"]])
    scope_cards = "\n".join([f'<div class="scope-card"><h4>{h}</h4><p>{p}</p></div>' for h, p in s["scope_items"]])
    numbered_cards = "\n".join([f'<div class="numbered-card"><div class="num">{num}</div><h4>{h}</h4><p>{p}</p></div>' for num, h, p in s["how_helps"]])
    expect_cards = "\n".join([f'<div class="expect-step"><div class="step-num">{i+1}</div><h4>{h}</h4><p>{p}</p></div>' for i, (h, p) in enumerate(s["expect_steps"])])
    stat_items = "\n".join([f'<div class="stat-item"><div class="num">{num}</div><div class="label">{label}</div></div>' for num, label in s["matters_stats"]])
    why_cards_html = "\n".join([f'<div class="why-card"><div class="icon">{icon}</div><h4>{h}</h4><p>{p}</p></div>' for icon, h, p in s["why_cards"]])
    ...
    trust_bar_html = "\n".join([f'<div class="trust-item">{t}</div>' for t in s["trust_items"]])
...
def build_city_page(svc_key, city_key):
    ...
    # HowTo steps from expect_steps (FIXED: json.dumps instead of repr)
    howto_steps = "\n".join([
